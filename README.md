...
**mmcv** doesn't officially support Python 3.12+, so it is recommended to use Python 3.11 - see https://github.com/open-mmlab/mmcv/issues/3263

But it seems that it should work on Python 3.12.10 win64 - https://github.com/open-mmlab/mmcv/issues/3263#issuecomment-2747343383
